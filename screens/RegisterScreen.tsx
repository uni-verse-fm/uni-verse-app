    ...
    >
      ...
      >
        <View style={tw`m-2 text-sm`}>
          ...
          <TextInput
            style={tw`text-lg bg-white dark:bg-drk p-1 rounded-lg `}
        ...
        >
          <Button color="white" title="Register" onPress={() => onLogin()} />
        </View>
      </View>
      <Text style={tw`text-base font-bold text-grn`} onPress={() => navigation.navigate("Login")} >Already have an account ?</Text>
    </SafeAreaView>
  );
};
